export const AUDIT_MODULES = [
  ...
  },
  {
    ...
    items: [
      ...
      'Despesas operacionais e perdas produtivas',
      'Consumo energético e eficiência logística',
      'Indicadores financeiros e rentabilidade operacional',
    ],
    objectives: [
  ...
  },
  {
    ...
    items: [
      ...
      'Indicadores de desempenho e controle documental',
      'Processos de faturamento e gestão de contratos',
      'Controle de fretes e gestão de equipes',
      'Sistema ERP e integração de dados',
    ],
    objectives: [
