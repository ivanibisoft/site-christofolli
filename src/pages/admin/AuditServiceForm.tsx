...
import { getAuditService, createAuditService, updateAuditService } from '@/services/audit-services'
...
export default function AuditServiceForm() {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (isEditing) {
        await updateAuditService(id!, data)
        toast({ title: 'Serviço atualizado com sucesso!' })
      } else {
        await createAuditService(data)
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-slate-800">
                        Itens Avaliados <span className="text-red-500">*</span>
                      </FormLabel>
                      <FormControl>
                        <Textarea
                ...
                <FormField
                  control={form.control}
                  name="objectives_and_deliveries"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-slate-800">
                        Objetivos e Entregas <span className="text-red-500">*</span>
                      </FormLabel>
                      <FormControl>
                        <Textarea
                          placeholder="Um item por linha..."
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
              ...
              >
                <Link to="/admin/audit-services">Cancelar</Link>
              </Button>
